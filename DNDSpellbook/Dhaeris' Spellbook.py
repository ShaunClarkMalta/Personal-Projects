...
#Bard Class
bard_lv1 = ("Animal Friendship", "Bane", "Charm Person", "Color Spray", "Command", "Comprehend Languages", "Creeping Touch", "Cure Wounds", "Daydream", "Detect Magic", "Disguise Self", "Dissonant Whispers", "Distort Value", "Earth Tremor", "Elf Shot", "Faerie Fire", "Feather Fall", "Healing Word", "Heroism", "Identify", "Illusory Script", "Longstrider", "Pratfall", "Silent Image", "Silvery Barbs", "Sleep", "Speak with Animals", "Tasha's Hideous Laughter", "Thunderwave", "Unseen Servant")
bard_lv2 = ("Aid", "Animal Messenger", "Blindness/Deafness", "Borrowed Knowledge", "Calm Emotions", "Cloud Of Daggers", "Crown of Madness", "Detect Thoughts", "Drayfn's Blunted Blade", "Dreamwalk", "Enhance Ability", "Enlarge/Reduce", "Enthrall", "Gift Of Gab", "Heat Metal", "Hold Person", "Invisibility", "Kinetic Jaunt", "Knock", "Lesser Restoration", "Locate Animals Or Plants", "Locate Object", "Magic Mouth", "Mirror Image", "Nathair's Mischief", "Ominous Winds", "Phantasmal Force", "Pyrotechnics", "See Invisibility", "Shatter", "Silence", "Skywrite", "Spray Of Cards", "Suggestion", "Ugly Duckling", "Warding Wind", "Zone Of Truth")
bard_lv3 = ()
...
cleric_lv2 = ("Aid", "Augury", "Blindness/Deafness","Bloodletter", "Borrowed Knowledge", "Calm Emotions", "Continual Flame", "Drayfn's Blunted Blade", "Enhance Ability", "Find Traps", "Gentle Repose", "Hold Person", "Lesser Restoration", "Life Tether", "Locate Object", "Ominous Winds", "Protection", "Shielding Word", "Prayer of Healing", "Preserve")
cleric_lv3 = ()
...
paladin_lv2 = ("Aid", "Bloodletter", "Drayfn's Blunted Blade", "Find Steed", "Gentle Repose", "Krail's Rupture", "Lesser Restoration", "Locate Object", "Magic Weapon", "Prayer of Healing", "Protection", "Protection From Poison", "Shielding Word", "Shining Smite", "Warding Bond", "Zone Of Truth")
paladin_lv3 = ()
paladin_spelllist = (paladin_lv1, paladin_lv2, paladin_lv3)

#Ranger
ranger_lv1 = ("Absorb Elements", "Air Bubble", "Alarm", "Animal Friendship", "Beast Bond", "Blade Of Blood And Bone", "Cure Wounds", "Detect Magic", "Detect Poison And Disease", "Elevated Sight", "Ensnaring Strike", "Entangle", "Fog Cloud", "Goodberry", "Hail Of Thorns", "Hunter's Mark", "Jump", "Longstrider", "Snare", "Speak With Animals", "Spiny Shield", "Zephyr Strike")
ranger_lv2 = ("Aid", "Air Bubble", "Ambush Prey", "Animal Messenger", "Barkskin", "Beast Sense", "Bloodsense", "Cordon Of Arrows", "Darkvision", "Drayfn's Blunted Blade", "Dreamwalk", "Enhance Ability", "Find Traps", "Gust Of Wind", "Healing Spirit", "Hibernation", "Krail's Maggot", "Krail's Rupture", "Lesser Restoration", "Locate Animals Or Plants", "Locate Object", "Magic Weapon", "Pass Without Trace", "Protection", "Protection From Poison", "Silence", "Spike Growth", "Summon Beast")
ranger_lv3 = ()
ranger_spelllist = (ranger_lv1, ranger_lv2, ranger_lv3)

#Sorcerer
sorcerer_lv1 = ("Absorb Elements", "Black Ribbons", "Burning Hands", "Catapult", "Chaos Bolt", "Charm Person", "Chromatic Orb", "Color Spray", "Comprehend Languages", "Creeping Touch", "Delerium Orb", "Detect Magic", "Disguise Self", "Earth Tremor", "Elf Shot", "Expeditious Retreat", "False Life", "Feather Fall", "Fog Cloud", "Gloaming", "Grease", "Ice Knife", "Jump", "Mage Armor", "Magic Missile", "Pratfall", "Ray Of Sickness", "Shadow Armor", "Shield", "Silent Image", "Silvery Barbs", "Sleep", "Spiny Shield", "Tasha's Caustic Brew", "Thunderwave", "Witch Bolt")
sorcerer_lv2 = ("Agnazzar's Scorcher", "Air Bubble", "Alter Self", "Arcane Vigor", "Blindness/Deafness", "Blur", "Cloud Of Daggers", "Crown Of Madness", "Dark Path", "Darkbolt", "Darkness", "Darkvision", "Detect Thoughts", "Dragon's Breath", "Drayfn's Blunted Blade", "Dust Devil", "Earthbind", "Enhance Ability", "Enlarge/Reduce", "Flame Blade", "Flaming Sphere", "Gust Of Wind", "Hold Person", "Invisibility", "Kinetic Jaunt", "Knock", "Krail's Rupture", "Levitate", "Life Tether","Magic Weapon", "Maximilian's Earthen Grasp", "Mind Spike", "Mirror Image", "Misty Step", "Nathair's Mischief", "Negative Image", "Ominous Winds", "Phantasmal Force", "Pyrotechnics", "Rime's Binding Ice", "Riptide", "Scorching Ray", "See Invisibility", "Shadow Adaptation", "Shadow Puppets", "Shatter", "Shielding Word", "Snilloc's Snowball Swarm", "Spider Vlimb", "Spray Of Cards", "Suggestion", "Tasha's Mind Whip", "Ugly Duckling", "Vortex Warp", "Warding Wind","Warp Bolt", "Warp Sense", "Web", "Wither And Bloom")
sorcerer_lv3 = ()
sorcerer_spelllist = (sorcerer_lv1, sorcerer_lv2, sorcerer_lv3)

#Warlock
warlock_lv1 = ("Armor Of Agathys", "Arms Of Hadar", "bane", "Black Ribbons", "Blade of Blood And Bone", "Cause Fear", "Charm Person", "Comprehend Languages", "Creeping Touch", "Daydream", "Delerium Orb", "Detect Magic", "Elevated Sight", "Expeditious Retreat", "Gloaming", "Hellish Rebuke", "Hex", "Illusory Script", "Peppermint Plate", "Pratfall", "Protection From Evil And Good", "Shadow Armor", "Shadow Hands", "Speak With Animals", "Tasha's Hideous Laughter", "Unseen Servant", "Veil Of Dusk", "Witch Bolt")
warlock_lv2 = ("Borrowed Knowledge", "Cloud of Daggers", "Crown of Madness", "Dark Path", "Darkbolt", "Darkness", "Drayfn's Blunted Blade", "Dreamwalk", "Earthbind", "Enthrall", "Flock Of Familiars", "Hold Person", "Invisibility", "Krail's Maggot", "Krail's Rupture", "Life Tether", "Mind Spike", "Mirror Image", "Misty Step", "Negative Image", "Ray Of Enfeeblement", "Riptide", "Shadow Adaptation", "Shadow Blade", "Shdow Puppets", "Spider Climb", "Spray Of Cards", "Suggestion", "Warp Bolt", "Warp Sense")
warlock_lv3 = ()
warlock_spelllist = (warlock_lv1, warlock_lv2, warlock_lv3)

#Wizard Class
wizard_lv1 = ("Absorb Elements", "Alarm", "Black Ribbons", "Burning Hands", "Catapult", "Cause Fear", "Charm Person", "Chromatic Orb", "Cloak Of Shadow", "Color Spray", "Comprehend Languages", "Creeping Touch", "Delerium Orb", "Detect Magic", "Disguise Self", "Earth Tremor", "Elevated Sight", "Elf Shot", "Expeditious Retreat", "False Life", "Feather Fall", "Find Familiar", "Flipperform", "Fog Cloud", "Frost Fingers", "Grease", "Ice Knife", "Identity", "Illusory Script", "Jim's Magic Missile", "Jump", "Longstrider", "Mage Armor", "Magic Missile", "Pratfall", "Protection From Evil And Good", "Shadow Armour", "Shadow Hands", "Shield", "Silent Image", "Silvery Barbs", "Sleep", "Snare", "Spiny Shield", "Tasha's Caustic Brew", "Tasha's Hideous Laughter", "Tenser's Floating Disk", "Thunderwave", "Unseen Servant", "Witch Bolt")
wizard_lv2 = ("Agnazzar's Scorcher", "Air Bubble", "Alter Self", "Arcane Lock", "Arcane Vigor", "Arcomagnetic Repulsion", "Augury", "Blindness/Deafness", "Blur", "Borrowed Knowledge", "Cloud Of Daggers", "Continual Flame", "Crown Of Madness", "Dark Path", "Darkbolt", "Darkness", "Darkvision", "Detect Thoughts", "Dragon's Breath", "Drayfn's Blunted Blade", "Dreamwalk", "Dust Devil", "Earthbind", "Enhance Ability", "Enlarge/ Reduce", "Flaming Sphere", "Flock Of Familiars", "Gentle Repose", "Gift Of Gab", "Gust Of Wind", "Hold Person", "Invisibility", "Jim's Glowing Coin", "Kinetic Jaunt", "Knock", "Krail's Rupture", "Levitate", "Life Tether", "Locate Object", "Maddening Whispers", "Magic Mouth", "Magic Weapon", "Maximillian's Earthen Grasp", "Melf's Acid Arrow", "Mind Spike", "Mirror Image", "Misty Step", "Nathair's Mischief", "Negative Image", "Nystul's Magic Aura", "Ominous Winds", "Phantasmal Force", "Protection", "Pyrotechnics", "Ray Of Enfeeblement", "Rime's Binding Ice",  "Riptide", "Rope Trick", "Scorching Ray", "See Invisibility", "Shadow Adaptation", "Shadow Blade", "Shadow Puppet", "Shatter", "Shielding Word", "Skywrite", "Slither", "Snilloc's Snowball Swarm", "Spider Climb", "Spray of Cards", "Suggestion", "Tasha's Mind Whip","Ugly Duckling", "Vortex Warp", "Warding Wind", "Warp Sense", "Web", "Wither And Bloom")
wizard_lv3 = ()
